...
# Chats & Users
ADMINS = [5036474012 1266733572] #os.environ.get("ADMINS", "2028425293 1637186875")
...
CHANNELS = -1001610770597 #[int(ch) if search.search(ch) else ch for ch in os.environ.get("CHANNELS", "-1001784382279").split()]
